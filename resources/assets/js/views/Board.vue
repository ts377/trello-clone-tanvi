...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            endEditing(task) {this.editingTask = null
        ...
        mounted(){let token = localStorage.getItem('jwt')
